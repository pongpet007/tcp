...
-- Dumping structure for table tcp.admin
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `sale_manager` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table tcp.admin: ~2 rows (approximately)
/*!40000 ALTER TABLE `admin` DISABLE KEYS */;
INSERT INTO `admin` (`user_id`, `username`, `password`, `level`, `fullname`, `position`, `dep_id`, `sale_manager`, `parent_user_id`, `team`, `is_active`, `cby`, `cdate`, `uby`, `udate`) VALUES
	(1, 'admin', 'brandex2515', 3, 'admin', 'Graphic', 3, 2, 2, '', 1, 'ชลธิสา สมาน', '2017-01-06 15:46:56', 'พงศ์เพชร มีทรัพย์', '2017-01-11 13:28:58'),
	(39, 'user', '1234', 1, 'admin', 'Graphic', 3, 2, 2, '', 1, 'ชลธิสา สมาน', '2017-01-06 15:46:56', 'พงศ์เพชร มีทรัพย์', '2017-01-11 13:28:58');
/*!40000 ALTER TABLE `admin` ENABLE KEYS */;

-- Dumping structure for table tcp.company
CREATE TABLE IF NOT EXISTS `company` (
  `com_id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`com_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- Dumping data for table tcp.company: 1 rows
/*!40000 ALTER TABLE `company` DISABLE KEYS */;
INSERT INTO `company` (`com_id`) VALUES
	(1);
/*!40000 ALTER TABLE `company` ENABLE KEYS */;

-- Dumping structure for table tcp.company_language
CREATE TABLE IF NOT EXISTS `company_language` (
  `company_language_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table tcp.company_language: 2 rows
/*!40000 ALTER TABLE `company_language` DISABLE KEYS */;
INSERT INTO `company_language` (`company_language_id`, `com_id`, `country_id`, `meta_title`, `meta_keyword`, `meta_description`, `com_name`, `com_desc_short`, `com_desc`, `com_address`, `cby`, `cdate`, `uby`, `udate`) VALUES
	(1, 1, 236, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 1, 221, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `company_language` ENABLE KEYS */;

-- Dumping structure for table tcp.counter
...
-- Dumping data for table tcp.counter: ~0 rows (approximately)
/*!40000 ALTER TABLE `counter` DISABLE KEYS */;
/*!40000 ALTER TABLE `counter` ENABLE KEYS */;

-- Dumping structure for table tcp.country
...
-- Dumping data for table tcp.country: ~251 rows (approximately)
