    ...
    <div class="">
      <div class="col-md-12" style="padding: 0; margin: 0;">
       ...
       <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <a class="carousel-control-prev control-banner" href="#carouselExampleCaptions" role="button" data-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next control-banner" href="#carouselExampleCaptions" role="button" data-slide="next">
